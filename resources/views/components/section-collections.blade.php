    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      @foreach($categories as $category)
        ...
        >
          ...
          <div class="absolute inset-0 bg-scm-gray-900 group-hover:scale-105 transition-transform duration-700 ease-out flex items-center justify-center">
          ...
          <div class="relative z-20 space-y-2 text-white">
            ...
            <h3 class="text-xl md:text-2xl font-black uppercase tracking-wider group-hover:translate-x-1 transition-transform duration-300">
              {{ $category->name }}
            </h3>
            ...
            <div class="pt-2">
              <span class="text-[11px] uppercase tracking-[0.25em] font-bold text-white group-hover:underline underline-offset-4 inline-flex items-center gap-1">
